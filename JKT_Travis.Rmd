...
# Introdution
We wish to develope a strategy for the deployment of a new beer, Blue Beer's Picasso.
Blue Beer's Picasso has higher than typical alcohol content (ABV= 0.06) while having
a lower than typical bitterness rating (IBU = 30). Market research has shown that Millenials
and iGen (>=21) prefer locally brewed beers, that have a high alcohol content but are not drawn
to highly bitter beers. Blue Beer's Picasso is looking to launch their brewery production in an
area with fewer than 10 breweries in the state, has a supporting demographic, and prefers beers 
with Blue Beer's ABV and IBU characteristics.
...
The states with the highest maximum alcoholic (ABV) beer is the District of Columbia and Kentucky with a median ABV of 0.0625.
```{r Question_5a}
...
The states with the most bitter (IBU) beer is Maine with a median IBU of 61.
```{r Question_5b}
